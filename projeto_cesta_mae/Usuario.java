...
public class Usuario {
	...
	public void setMoradores(int moradores) {
		...
		public void validarRenda(){
			...
			System.out.println("\nQuantos moradores tem na sua residência? ");
			...
			if(rendaFinal < 500) {
				...
				System.out.println("\nVocê está apto a prosseguir no programa! Continue com o cadastro!");
			
			}else { 
					
					System.out.println("\nVocê não está apto a prosseguir no programa! ");
			...
			public void login() {
				...
				System.out.println("\nParabéns, cadastro finalizado! Aguardar a aprovação!");
